// frontend/web-app/src/components/toast/icons.tsx
// Ícones inline (sem dependência de @mui/icons-material) para o sistema de toasts.
interface IconProps {
  className?: string;
}
...
export function WarningAmberIcon({ className }: IconProps) {
  return (
    <svg className={className} width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
