...
4. Apenas administradores têm permissão para aprovar ou suspender parceiros.
5. Administradores podem avaliar e alterar a aprovação do perfil de usuários a qualquer momento.
