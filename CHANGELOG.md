...
| 2026-07-28 | FEAT-033 | Perfil Estendido, Aprovação de Admins & Avatar: adicionados campos (nome completo, data de nascimento, gênero, foto/avatar com trava de 10MB), status de perfil pendente de avaliação, cadastro de ADMIN no status PENDING_APPROVAL com acesso bloqueado até aprovação prévia por outro admin + notificação por e-mail, e componente de avatar simbólico/foto no Header |
