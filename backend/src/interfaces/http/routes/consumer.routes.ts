...
import { ToggleConsumerStatusController } from '../controllers/consumer/ToggleConsumerStatusController';
...
const toggleConsumerStatusUseCase = new ToggleConsumerStatusUseCase(consumerRepository);
...
const toggleConsumerStatusController = new ToggleConsumerStatusController(toggleConsumerStatusUseCase);
...
router.patch('/status', authMiddleware, (req, res) => toggleConsumerStatusController.execute(req, res));
